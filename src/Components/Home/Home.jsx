  ...
  return (
    <main className="w-11/12 mt-10 flex flex-col gap-10">
      ...
      <div className="flex flex-col w-full md:flex-row gap-5">
        <div className="relative w-full min-h-96 group bg-cover bg-center flex flex-col items-center pt-16 gap-5 text-white overflow-hidden rounded-lg text-center">
          <img
