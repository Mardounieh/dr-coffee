...
export default function ExploreCard(props) {
  return (
    ...
    >
      ...
      <h2 className="text-xl md:text-2xl lg:text-3xl font-bold">{props.title}</h2>
      <button className="flex items-center gap-1 bg-white py-1.5 px-4 rounded-full text-black text-xs md:text-sm font-light hover:text-white hover:bg-red-600 duration-200">
